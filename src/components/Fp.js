...
import youblog from "../icons/youblog3.png";

const Fp = () => {
  const nav = useNavigate();
  return (
    // <div className='bg-gradient-to-r from-[#e66465] to-[#9198e5] h-screen' >
    // <div className='text-white font-semibold text-2xl flex flex-col items-center justify-center h-3/4'>Welcome to YOUBLOG
    // <img src={youblog} alt="youblog" className='w-12 h-12'/></div>

    <div
      class="h-screen overflow-hidden flex items-center justify-center bg-gradient-to-r from-[#e66465] to-[#9198e5];"
    ...
    >
      <div>
        <div class="sticky top-0 z-50">
          <div>
            <div class="w-screen opacity-90 h-20 flex justify-between ">
        ...
        <div class="relative overflow-hidden text-black rounded-lg sm:mx-16 mx-2 sm:py-16">
          <div class="relative z-10 max-w-screen-xl px-4  pb-20 pt-10 sm:py-24 mx-auto sm:px-6 lg:px-8">
            <div class="max-w-xl sm:mt-1 mt-80 space-y-8 text-center sm:text-right sm:ml-auto">
              {/* <h2 class="text-4xl font-bold sm:text-5xl">
               YOUBLOG
                <span class="hidden sm:block text-4xl"></span>
              </h2> */}
      ...
      {/* <button onClick={() => nav("/portal/")} className="border border-black">
        go to login page
      </button> */}
    </div>
  );
