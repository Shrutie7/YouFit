...
const Plan = () => {
  ...
  <div class="py-8 px-4 lg:py-10 lg:px-6">
       <div class="mx-auto max-w-screen-md text-center mb-8 lg:mb-12">
          ...
          {parseInt(loginDetails.roleId) !== parseInt(1) ? <p class="mb-5 font-light text-gray-500 sm:text-xl dark:text-gray-200">Ready to elevate your fitness game? Select the plan that suits your goals and kickstart your wellness adventure!</p>:<button className="mx-auto mb-8 max-w-screen-md text-center bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={()=>nav("plancreate")}>Create Plan</button>}  
      </div>
      ...
      <div class="space-y-8 lg:grid lg:grid-cols-4 sm:gap-6 xl:gap-16 lg:space-y-0">
          ...
          <div class="flex flex-col p-6 mx-auto max-w-lg text-center text-gray-900 bg-white rounded-lg border border-gray-100 shadow dark:border-gray-600 xl:p-8 dark:bg-gray-800    dark:text-white">
              ...
              <button className = "bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={()=>nav("checkout")}>Buy Now</button>
          </div>
