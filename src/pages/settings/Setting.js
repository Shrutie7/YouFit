...
const Setting = () => {
  ...
  <div class=" container mx-auto max-w-3xl mt-20 h-screen pt-3">
    ...
    <div className='bg-gray-200 overflow-scroll h-[85%]'>
    ...
    <ul class="flex border-b border-gray-300 text-sm font-medium text-gray-600 mt-3 px-6 md:px-6">
      ...
      <li class="mr-8 hover:text-gray-900"><a href="#_" class={`${tab==="planupdate" ? "underline":"no-underline"} py-4 inline-block text-black text-base font-sans font-semibold`} onClick={()=>settab("planupdate")}>Plan Update</a></li>
    </ul>
     <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
        <div class="w-1/3 bg-gray-100 p-8 hidden md:inline-block">
          <h2 class="font-medium text-md text-gray-700 mb-4 tracking-wide">{tab==="profileinfo" ?"Profile Info":tab==="passwordupdate" ? "Password Update":"Plan Update"}</h2>
        ...
        <div class="md:w-2/3 w-full px-8 pt-6 pb-8 mb-4  flex flex-col">
